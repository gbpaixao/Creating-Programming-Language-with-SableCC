...
public final class AOpMaiorIgualExpLogica extends PExpLogica
{
    private PExpAux _left_;
    private PExpAux _right_;

    public AOpMaiorIgualExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOpMaiorIgualExpLogica(
    ...
    {
        ((Analysis) sw).caseAOpMaiorIgualExpLogica(this);
    }
