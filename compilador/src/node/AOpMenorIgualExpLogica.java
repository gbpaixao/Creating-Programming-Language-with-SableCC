...
public final class AOpMenorIgualExpLogica extends PExpLogica
{
    private PExpAux _left_;
    private PExpAux _right_;

    public AOpMenorIgualExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOpMenorIgualExpLogica(
    ...
    {
        ((Analysis) sw).caseAOpMenorIgualExpLogica(this);
    }
